...
plt.plot(x_valuesA, y_valuesA, marker='o', linestyle=' ', color='r', label='Äpfel')
plt.plot(x_valuesB, y_valuesB, marker='x', linestyle=' ', color='g', label='Birnen')
plt.title('Äpfeln und Birnen - Datensatz')
plt.xlabel('Rundheit')
plt.ylabel('Durchschnitt H-Wert')
